...
<head>
  ...
  <input id="role-save" type="text" class="is-hidden" value="<?php echo $role; ?>">
    ...
    <link rel="stylesheet" href="css/townhouse/townhouse.css">
    <link rel="stylesheet" href="css/townhouse/jquery.css">
</head>
<body>
  <!-- Container -->
        ...
        <div id="navbar-menu-id" class="navbar-menu is-dark">
          <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
              ...
              <!-- List item dropdown -->
              <div class="navbar-dropdown is-dark">
                <a class="navbar-item active-item" href="townhouse.php">
                  Townhouse
                </a>
          ...
          <div class="container">
            <div class="columns is-gapless is-multiline is-mobile">
              <div class="column is-full-mobile is-half-tablet is-half-desktop is-half-widescreen is-half-fullhd">
                ...
                <img src="image/nha-pho-dep.jpg" width="500" alt="Photo">
                <br>
                <span><b>Photo 1:</b><i> Beautiful townhouse</i></span>
                <br><br>
              ...
              <div class="column is-full-mobile is-half-tablet is-half-desktop is-half-widescreen is-half-fullhd">
                <h4>Price list of townhouse designs</h4>
      ...
      <div class="columns is-desktop is-multiline background-footer">
        ...
        <div class="column is-half-desktop is-full-tablet is-full-mobile">
          ...
          <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
              <input id="name" name="name" class="input" type="text" placeholder="Your name" onblur="checkText('name')">
              <span class="icon is-small is-left">
                <i class="fas fa-user"></i>
              </span>
              <span class="icon is-small is-right">
          ...
          <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
              <input id="email" name="email" class="input" type="email" placeholder="Enter email" onblur="checkText('email')">
              <span class="icon is-small is-left">
                <i class="fas fa-envelope"></i>
              </span>
              <span class="icon is-small is-right">
          ...
          <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
              <input id="phone" name="phone" class="input" type="text" placeholder="Enter your phone number" onblur="checkText('phone')">
              <span class="icon is-small is-left">
          ...
          <div class="control">
            <input id="submit" type="button" class="button is-link" value="Submit" onclick="checkText('all')">
          </div>         
        </div>
      </div>
    </div>
